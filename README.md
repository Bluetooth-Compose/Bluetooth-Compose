...
- As it turns out, there is a commercial relationship between population density and the obligation of local authorities to provide street-lighting that meets a minimum distance-based specification - and that means that there is already the obligation of local authorities to provide street-light-posts as essentially being already available to be used as 'defacto-smart-city-transmission-towers' and which defacto smart-city-transmission-tower density is already budgetted to increase as population density increaeses.
